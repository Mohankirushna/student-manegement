...
print("29 days(feburary)(or)31 days(janaury,marh,may,july,augest,october,december)(or)30 days (april,june,september,november")
Day = input("Type the number of days of this month:")
print("you selected month as :"+Day)
print("""
      1.january
      2.feburary
      3.march
...
print("kp " + " | " + Rollno4+"\t\t\t|")
print("sai " + " | " + Rollno5+"\t\t\t|")
print("vineeth " + " | " + Rollno6+"\t\t\t|")
print("abs " + " | " + Rollno7+"\t\t\t|")
print("swamy " + " | " + Rollno8+"\t\t\t|")
print("jaidev" + " | " + Rollno9+"\t\t\t|")
print(" | |")
print("-----------------------------------")
